...
# 文件命名配置
from config.file_naming import (
    GLOBAL_NAMING_MODE, ARIMA_NAMING_CONFIG, CLASSICAL_DECOMPOSITION_NAMING_CONFIG,
    DATA_PROCESSING_NAMING_CONFIG, PROPHET_NAMING_CONFIG, OPTIMIZATION_NAMING_CONFIG
)
